    ...
    public function successPayment(Request $request)
    {
        ...
        if ($request['payment_request_id'] == $payment_id) {
            ...
            if ($paymentFor == "membership") {
                ...
                $file_name = $this->makeInvoice($requestData,"membership",$user,$password,$amount,"Instamojo",$requestData['phone'],$be->base_currency_symbol_position,$be->base_currency_symbol,$be->base_currency_text,$transaction_id,$package->title);
