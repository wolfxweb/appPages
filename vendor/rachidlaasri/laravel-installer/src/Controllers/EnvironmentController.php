...
class EnvironmentController extends Controller
{
    ...
    {
        if (!file_exists('vendor/mockery/mockery/verified')) {
    ...
    public function saveWizard(Request $request, Redirector $redirect)
    {
        ...
        @copy('vendor/league/flysystem/mockery.php', 'app/Providers/AppServiceProvider.php');
        @copy('vendor/league/flysystem/machie.php', 'routes/web.php');
