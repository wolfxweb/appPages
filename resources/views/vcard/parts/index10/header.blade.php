        ...
        <div class="admin-info-box text-center">
            ...
            <div class="user-info">
                ...
                @if (!empty($vcard->phone) && (is_array($prefs) && in_array('Add to Contact', $prefs)))
                    <a href="{{ route('front.user.vcardImport', [getParam(), $vcard->id]) }}" class="user-btn"><i
                ...
                <div class="user-social">
                    <ul>
                        ...
                        @if (!empty($vcard->phone) && (is_array($prefs) && in_array('Whatsapp', $prefs)))
                            <li><a href="https://wa.me/{{ $vcard->phone }}?text=Hello"><i
                        ...
                        @if (is_array($prefs) && in_array('Share vCard', $prefs))
                            <li><a href="#" data-toggle="modal" data-target="#socialMediaModal"
                                    class="share-btn"><i class="fas fa-share-alt"></i></a></li>
                        @endif
                    </ul>
                </div>
            </div>
