        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-inline-block">QR Codes</div>
                    <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{route('user.qrcode.bulk.delete')}}"><i class="flaticon-interface-5"></i> Delete</button>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                                    ...
                                    <table class="table table-striped mt-3" id="basic-datatables">
                                        ...
                                        @foreach ($qrcodes as $key => $qrcode)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{asset('assets/front/img/user/qr/' . $qrcode->image)}}" download="{{$qrcode->name}}.png" class="btn btn-secondary btn-sm">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="urlsModalLabel">QR Code</h5>
                                                        ...
                                                        <div class="modal-footer justify-content-center">
                                                            <a href="{{asset('assets/front/img/user/qr/' . $qrcode->image)}}" download="{{$qrcode->name}}.png" class="btn btn-secondary">
                                                                <i class="fas fa-download"></i> Download
                                                            </a>
                                                        </div>
                                                    </div>
