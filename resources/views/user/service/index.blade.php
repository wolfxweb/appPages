         ...
         <div class="modal-body">
            ...
            <form id="ajaxForm" enctype="multipart/form-data" class="modal-form" action="{{route('user.service.store')}}" method="POST">
               ...
               <div class="form-group">
                  ...
                  <p class="text-warning mb-0"><small>Quanto maior o número de série, mais tarde o serviço será exibido.</small></p>
               </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="d-flex">
                        ...
                        <div class="radio mr-3">
                            <label><input type="radio" name="detail_page" value="1" checked class="mr-1">Ativo</label>
                        </div>
                        <div class="radio">
                            <label><input type="radio" name="detail_page" value="0" class="mr-1">Inativo</label>
                        </div>
                    </div>
