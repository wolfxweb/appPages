                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <p class="text-warning mb-0">Use este nome para identificar um cartão
                                                específico da sua lista de cartões.</p>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="direction" class="form-control" id="direction">
                                                ...
                                                <option value="1" {{ $vcard->direction == 1 ? 'selected' : '' }}>LTR
                                                    (Da esquerda para direita)</option>
                                                <option value="2" {{ $vcard->direction == 2 ? 'selected' : '' }}>RTL
                                                    (Da direita para esquerda)</option>
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control {{ $vcard->direction == 2 ? 'rtl' : '' }}"
                                                name="name" value="{{ $vcard->name }}" placeholder="">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control {{ $vcard->direction == 2 ? 'rtl' : '' }}"
                                                name="company" value="{{ $vcard->company }}" placeholder="">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control {{ $vcard->direction == 2 ? 'rtl' : '' }}"
                                                name="occupation" value="{{ $vcard->occupation }}" placeholder="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control ltr" name="phone"
                                                value="{{ $vcard->phone }}" placeholder="">
                                            <p class="text-warning mb-0">Digite o numero de telefone com <strong
                                                    class="text-danger">Código DDD</strong></p>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control {{ $vcard->direction == 2 ? 'rtl' : '' }}"
                                                name="address" value="{{ $vcard->address }}" placeholder="">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control ltr" name="website_url"
                                                value="{{ $vcard->website_url }}" placeholder="">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <button class="btn btn-primary" @click="addInformation">Adicionar
                                                    informação</button>
                                            </div>
                                        </div>
                                    </div>
