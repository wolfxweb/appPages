   ...
   <div class="col-md-12">
      <div class="card">
         <div class="card-header">
            <div class="row">
               <div class="col-lg-4">
                  <div class="card-title d-inline-block">Postagens</div>
               </div>
               <div class="col-lg-3">
                  <!--
               ...
               <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                   @if(!is_null($userDefaultLang))
                      ...
                      <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete" data-href="{{route('user.blog.bulk.delete')}}"><i class="flaticon-interface-5"></i> <i class="fas fa-exclamation-square    "></i></button>
                   @endif
               </div>
            </div>
         </div>
   ...
   <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Adicionar postagem</h5>
         ...
         <div class="modal-body">
            ...
            <form id="ajaxForm" enctype="multipart/form-data" class="modal-form" action="{{route('user.blog.store')}}" method="POST">
               ...
               <div class="form-group">
                  ...
                  <p class="text-warning mb-0"><small>Quanto maior o número de série, mais tarde o blog será exibido.</small></p>
               </div>
               <div class="form-group">
