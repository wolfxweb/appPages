                ...
                <div class="form-group">
                  <label for="">Permissions: </label>
                	<div class="selectgroup selectgroup-pills mt-2">
                        ...
                        <label class="selectgroup-item">
                            <input type="checkbox" name="permissions[]" value="Payment Log" class="selectgroup-input" @if(is_array($permissions) && in_array('Payment Log', $permissions)) checked @endif>
                            <span class="selectgroup-button">Payment Log</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="checkbox" name="permissions[]" value="Subdomains" class="selectgroup-input" @if(is_array($permissions) && in_array('Subdomains', $permissions)) checked @endif>
                            <span class="selectgroup-button">Subdomains</span>
                        </label>
                        <label class="selectgroup-item">
                            <input type="checkbox" name="permissions[]" value="Custom Domains" class="selectgroup-input" @if(is_array($permissions) && in_array('Custom Domains', $permissions)) checked @endif>
                            <span class="selectgroup-button">Custom Domains</span>
                        </label>
                		<label class="selectgroup-item">
