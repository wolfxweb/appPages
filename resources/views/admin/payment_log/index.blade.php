                            ...
                            <table class="table table-striped mt-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a target="_blank" href="{{route('register.user.view', $membership->user_id)}}">{{$membership->user->username}}</a></td>
                                        <td><a target="_blank" href="{{route('admin.package.edit', $membership->package_id)}}">{{$membership->package->title}} [{{$membership->package->term}}]</a></td>
                                        @php
